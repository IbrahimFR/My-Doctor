        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                   Clinic Service<small> View service</small>
                </h1>
                <ol class="breadcrumb">
                                        ...
                                        <c:forEach items="${service}" var="services">
                                            <tr>
                                               ...
                                               <c:out value="${services.name}" /> </td>
                                                ...
                                                <%--<td>--%>
                                                    <%--<form action="${pageContext.request.contextPath}/admin/clinic/service/delete" method="post">--%>

                                                        <%--<button type="submit" class="btn btn-xs btn-danger">delete</button >--%>
                                                        <%--<input  type ="hidden" class="form-control"   value="<c:out value="${services.serviceId}" />"  name="id" id="_id"/>--%>
