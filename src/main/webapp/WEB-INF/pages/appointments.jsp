...
<c:forEach items="${appointments}" var="appointments">
    <tr>
       ...
       <td>
        <form action="${pageContext.request.contextPath}/appointment/app/cancel" method="post">
       <input  type ="hidden" class="form-control"   value="<c:out value="${appointments.id}" />"  name="id" id="_id"/>
            <button type="submit" style="margin-top: 10px" class="btn btn-xs btn-warning">Cancel</button>
