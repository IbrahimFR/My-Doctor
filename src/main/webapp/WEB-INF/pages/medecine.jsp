    ...
    <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Medecines<small>  (Add & View)</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-gear"></i> Medecines List
                            </li>
                        </ol>
                    </div>
                </div>
              ...
              <!--   <div class="row">
                ...
                <div class="alert alert-success">
                    <strong>${wellMessage}</strong> ${addMedecineMessage}
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i> Add Medecine</h3>
                            </div>
                            <div class="panel-body">

                        <form data-toggle="validator"  action="${pageContext.request.contextPath}/medecine/add" method="post">
                                <div class="form-group">
                                <label>Medecine Name</label>
                                <input type="text" class="form-control" class="form-control" name="medecineName" required>
                                </div>
                               <div class="form-group">
                                <label>Descreption</label>
                                <textarea type="text" rows="3" name="descreption"></textarea>
                               </div>
        ...
        <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-file fa-fw"></i>Medecines List</h3>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                        <c:forEach items="${medecine}" var="medecines">
                                            <tr>
                                                <td><c:out value="${medecines.medecineName}" /></td>
                                                <td><c:out value="${medecines.descreption}" /></td>
                                                <td><c:out value="${medecines.createddAt}" /></td>
                                               <td>

                                                    <form action="${pageContext.request.contextPath}/medecine/delete" method="post">
                                                        <input  type ="hidden" class="form-control"   value="<c:out value="${medecines.id}" />"  name="id" id="_id"/>
                                                        <button style="margin-top:2px" type="submit" class="btn btn-xs btn-danger">delete</button>
                                                        <input type="hidden" name="${_csrf.parameterName}"
                                                               value="${_csrf.token}" />
                                                    </form>
                                                </td>
