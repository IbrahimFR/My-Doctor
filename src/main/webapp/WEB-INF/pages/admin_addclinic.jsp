								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label>User Name</label> <input class="form-control"
												id="inputName" type="text" class="ii form-control " name="name"  required>
									</div>
										<div class="form-group">
									...
									<div class="form-group">
										<label>Email</label> <input class="form-control"
											id="inputEmail" type="email" class="ii form-control " name="email" data-error="Bruh, that email address is invalid" required>
									</div>
										<div class="form-group">
											<label>Mobile</label> <input class="form-control"
																			   id="_mobile" type="tel" class="ii form-control " name="mobile" required>
										</div>
										<div class="form-group">
										...
										<%--<input id="submit" onclick="getLocation()" type="button" value="Get Address">--%>
											...
											<input type="hidden" id="_Lang" name="Lang" value="" />
									...
									<div class="form-group">
										<label>Password</label> <input class="form-control"
											type="password" id="inputPassword" class="ii form-control "
											name="password" data-minlength="6" required>
									...
									<div class="form-group">
										<button id="hh" type="submit" class="btn btn-success">Submit</button>
