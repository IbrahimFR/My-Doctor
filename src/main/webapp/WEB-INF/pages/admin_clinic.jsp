				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							Clinics<small> View Clinics</small>
						</h1>
						<ol class="breadcrumb">
							...
							<tbody>
									<c:forEach items="${clinics}" var="clinic">
										<tr>
											...
											<td>
												<form action="${pageContext.request.contextPath}/admin/clinic/info" method="post">
										...
										<td>
											<form action="${pageContext.request.contextPath}/admin/clinic/reservation" method="post">
												<input  type ="hidden" class="form-control"   value="<c:out value="${clinic.id}" />"  name="id" id="_id"/>
												<button style="margin-top:2px" type="submit" class="btn btn-xs btn-default">Show</button>
												<input type="hidden" name="${_csrf.parameterName}"
													   value="${_csrf.token}" />
										...
										<td>
											<form action="${pageContext.request.contextPath}/admin/clinic/appointment" method="post">
												<input  type ="hidden" class="form-control"   value="<c:out value="${clinic.id}" />"  name="id" id="_id"/>
												<button style="margin-top:2px" type="submit" class="btn btn-xs btn-default">Show</button>
												<input type="hidden" name="${_csrf.parameterName}"
													   value="${_csrf.token}" />
										...
										<td>
											<form action="${pageContext.request.contextPath}/admin/clinic/patient" method="post">
												<input  type ="hidden" class="form-control"   value="<c:out value="${clinic.id}" />"  name="id" id="_id"/>
												<button style="margin-top:2px" type="submit" class="btn btn-xs btn-default">Show</button>
												<input type="hidden" name="${_csrf.parameterName}"
													   value="${_csrf.token}" />
										...
										<td>
											<form action="${pageContext.request.contextPath}/admin/clinic/service" method="post">
												<input  type ="hidden" class="form-control"   value="<c:out value="${clinic.id}" />"  name="id" id="_id"/>
												<button style="margin-top:2px" type="submit" class="btn btn-xs btn-default">Show</button>
												<input type="hidden" name="${_csrf.parameterName}"
													   value="${_csrf.token}" />
										...
										<td>
											<form action="${pageContext.request.contextPath}/admin/clinic/doctor" method="post">
												<input  type ="hidden" class="form-control"   value="<c:out value="${clinic.id}" />"  name="id" id="_id"/>
												<button style="margin-top:2px" type="submit" class="btn btn-xs btn-default">Show</button>
												<input type="hidden" name="${_csrf.parameterName}"
													   value="${_csrf.token}" />
										...
										<td>
											<form action="${pageContext.request.contextPath}/admin/clinic/medicine" method="post">
												<input  type ="hidden" class="form-control"   value="<c:out value="${clinic.id}" />"  name="id" id="_id"/>
												<button style="margin-top:2px" type="submit" class="btn btn-xs btn-default">Show</button>
												<input type="hidden" name="${_csrf.parameterName}"
													   value="${_csrf.token}" />
										...
										<td>
											<form action="${pageContext.request.contextPath}/admin/clinic/feedback" method="post">
												<input  type ="hidden" class="form-control"   value="<c:out value="${clinic.id}" />"  name="id" id="_id"/>
												<button style="margin-top:2px" type="submit" class="btn btn-xs btn-default">Show</button>
												<input type="hidden" name="${_csrf.parameterName}"
													   value="${_csrf.token}" />
											...
											<td><c:out value="${clinic.active}" /></td>
