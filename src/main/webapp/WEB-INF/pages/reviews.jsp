        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                    <c:forEach items="${reviews}" var="reviewsa">
                        <tr>
                            <td><c:out value="${reviewsa.createdAt}" /></td>
                            <td><c:out value="${reviewsa.updatedAt}" /></td>
                            <td><c:out value="${reviewsa.rate.toString()}" /></td>
                            <td><c:out value="${reviewsa.userId.username}" /></td>
