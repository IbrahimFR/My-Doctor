            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Clinic <small>Rating & Reviews</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-user-o"></i>Rating & Reviews
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <c:forEach items="${rates}" var="rate">
                        <tr>
                            <td><c:out value="${rate.createdAt}" /></td>
                            <td><c:out value="${rate.updatedAt}" /></td>
                            <td><c:out value="${rate.rate.toString()}" /></td>
                            <td><c:out value="${rate.userId.username}" /></td>
