				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="active"><i class="fa fa-tasks"></i> Reservation</li>
						</ol>
					</div>
				</div>
								...
								<tbody>
									<c:forEach items="${reservations}" var="reservation">
										<tr>
											...
											<td><c:out value="${reservation.userStatus}" /></td>
											<td><c:out value="${reservation.reserveType}" /></td>
											<td><c:out value="${reservation.service}" /></td>
											<td>

												<form action="${pageContext.request.contextPath}/appointment/add " method="post">
												<input  type ="hidden" class="form-control"   value="<c:out value="${reservation.id}" />"  name="id" id="_id"/>
												<%--<input type="hidden" class="form-control" value="<c:out value="${reservation.clinicName}" />" name="clinicName" id="_clinicId"/>--%>
												<%--<input type="hidden" class="form-control"  value="<c:out value="${reservation.userName}" />" name="userName" id="_userId"/>--%>
												<%--<input type="hidden"  class="form-control" value="<c:out value="${reservation.reserveType}" />" name="reserveType" id="_reserveType">--%>
												<%--<input type="hidden" class="form-control" value="<c:out value="${reservation.userStatus}" />" name="userStatus" id="_userStatus">--%>
											...
											<form action="${pageContext.request.contextPath}/appointment/cancel" method="post">
												<input  type ="hidden" class="form-control"   value="<c:out value="${reservation.id}" />"  name="id" id="_id1"/>
											<button type="submit" style="margin-top: 3px" class="btn btn-xs btn-danger">Reject</button>
											<input type="hidden" name="${_csrf.parameterName}"
													   value="${_csrf.token}" />
											</form>
